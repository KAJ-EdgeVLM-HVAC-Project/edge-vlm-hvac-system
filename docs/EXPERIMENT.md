...
에너지 모델: Fan1/2/3 = 800/1200/1600 W (룰베이스는 재실 중 Fan2 상시).
...
| 지표 | AI 제어 | 룰베이스 |
|---|---|---|
| **총 에너지** | **243.33 Wh** | 465.00 Wh |
| **에너지 절감** | **−221.67 Wh (−47.7%)** | — |
| 쾌적율 (PMV ±0.5) | 85.9% | 84.6% |
| 평균 실내온도 | 21.62 °C | 22.97 °C |

### 핵심 해석
- **에너지 47.7% 절감** — AI는 쾌적 도달 시 OFF + 공실 OFF + 저전력 팬으로
  운전한 반면, 룰베이스는 재실 내내 24°C·Fan2를 상시 유지.
